                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide px-md-8 ">
                                <div class="position-relative text-center">
                                    ...
                                    <img src="{{ asset('webassets/assets/images/slider-img-2.png') }}" alt=""
                            ...
                            <div class="swiper-slide px-md-8 ">
                                <div class="position-relative text-center">
                                    <img src="{{ asset('webassets/assets/images/slider-img-1.png') }}" alt=""
                                        class="img-fluid my-5 my-lg-0">
                                    <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
                            ...
                            <div class="swiper-slide px-md-8 ">
                                <div class="position-relative text-center">
                                    ...
                                    <img src="{{ asset('webassets/assets/images/slider-img-3.png') }}" alt=""
                                        class="img-fluid my-5 my-lg-0">
                                    <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
                    ...
                    <div class="swiper-container swiper" id="swiper-3" data-pagination-type="bullets" data-speed="400"
                        ...
                        <div class="swiper-wrapper pb-10">
                            <div class="swiper-slide">
                                <div>
                                    <a href="#"><img
                                            src="{{ asset('webassets/assets/images/product-img-1.jpg') }}"
                            ...
                            <div class="swiper-slide">
                                <div>
                                    <a href="#"><img
                                            src="{{ asset('webassets/assets/images/product-img-2.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <div class="text-center">
                                        <h3 class="mt-3 h5">
                                            <a href="#">
                            ...
                            <div class="swiper-slide">
                                <div>
                                    <a href="#"><img
                                            src="{{ asset('webassets/assets/images/product-img-5.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <div class="text-center">
                                        <h3 class="mt-3 h5">
                                            <a href="#">
                            ...
                            <div class="swiper-slide">
                                <div>
                                    <a href="#"><img
                                            src="{{ asset('webassets/assets/images/product-img-6.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <div class="text-center">
                                        <h3 class="mt-3 h5">
                                            <a href="#">
                            ...
                            <div class="swiper-slide">
                                <div>
                                    <a href="#"><img
                                            src="{{ asset('webassets/assets/images/product-img-3.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                    <div class="text-center">
                                        <h3 class="mt-3 h5">
                                            <a href="#">
            ...
            <div class="row justify-content-center mx-lg-10">
                <div class="col-lg-8 text-center">
                    ...
                    <form class="d-flex justify-content-center gap-2 flex-column flex-sm-row">
                        <input type="email" class="form-control w-lg-50 w-100" placeholder="Enter your email"
                            required>
